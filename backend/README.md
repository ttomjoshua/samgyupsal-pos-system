...
- server-side admin automation
- private APIs
- scheduled jobs outside Supabase
- stricter production-only orchestration

For the current capstone system, there is no implemented custom backend service here yet.
